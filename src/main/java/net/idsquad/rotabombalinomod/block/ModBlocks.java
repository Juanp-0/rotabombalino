...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ALTAR_ROTABOMBALINO = registerBlock("invocation_altar",
            () -> new InvocationAltarBlock(BlockBehaviour.Properties.of().noOcclusion().strength(4f).requiresCorrectToolForDrops()
                    .sound(SoundType.STONE).lightLevel(state -> state.getValue(InvocationAltarBlock.CLICKED) ? 15 : 0)));
